...
class CommentActions extends StatefulHookConsumerWidget {
  const CommentActions({super.key, required this.comment});

  final Comment comment;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CommentActionsState();
}
...
class _CommentActionsState extends ConsumerState<CommentActions> {
  ...
  Widget build(BuildContext context) {
    final isOwnPost =
        ref.watch(userProvider).profile!.id == widget.comment.createdBy;
